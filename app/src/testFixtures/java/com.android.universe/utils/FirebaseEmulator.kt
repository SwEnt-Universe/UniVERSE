...
object FirebaseEmulator {
    ...
    /**
     * Connects the Firebase instance to the local emulators.
     * This MUST be called after FirebaseApp.initializeApp() has run.
     *
     * @param isRobolectric Set to true when running on Robolectric (uses localhost),
     * false when running on an Android Emulator (uses 10.0.2.2).
     */
    fun connect(isRobolectric: Boolean = true) {
