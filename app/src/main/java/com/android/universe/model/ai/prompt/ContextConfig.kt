 ...
 *
 * Determines **where**, **when**, and **within what radius** events should be
 * generated for the user. These values help the prompt builder precisely scope
 * the request sent to the OpenAI event generator.
 *
 * @property location Optional human-readable location name (e.g., "Lausanne").
 *   Defaults to `"Lausanne"` for convenience during development.
 * @property locationCoordinates Optional geographic coordinates (latitude, longitude)
 *   used for map placement or distance filtering.
 * @property radiusKm Optional radius in kilometers within which events should be generated.
 * @property timeFrame Optional natural-language description of the desired time window
 *   (e.g., `"today"`, `"this week"`, `"next month"`).
 *
