 ...
 *
 * Provides simulated location data for testing and UI previews.
 * Emits a predefined set of locations without accessing device hardware,
 * allowing screens and ViewModels to function independently of real location services.
 */
class FakeLocationRepository : LocationRepository {

    private val fakeLocations = listOf(
        Location(47.3769, 8.5417),
        Location( 46.9481, 7.4474),
