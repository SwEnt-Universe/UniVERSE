  ...
  val sampleEvents =
      listOf(
          Event(
              ...
              participants = setOf(sampleUsers[0], sampleUsers[1], sampleUsers[1]),
          ...
          Event(
              ...
              participants = setOf(sampleUsers[2], sampleUsers[6], sampleUsers[10]),
          ...
          Event(
              ...
              participants = setOf(sampleUsers[7], sampleUsers[8], sampleUsers[0]),
          ...
          Event(
              ...
              participants = setOf(sampleUsers[9], sampleUsers[11]),
          ...
          Event(
              ...
              participants = setOf(sampleUsers[11], sampleUsers[5]),
          ...
          Event(
              ...
              participants = setOf(sampleUsers[6], sampleUsers[2], sampleUsers[10]),
          ...
          Event(
              ...
              participants = setOf(sampleUsers[5], sampleUsers[9], sampleUsers[15]),
              creator = sampleUsers[5],
          ...
          Event(
              ...
              participants = setOf(sampleUsers[6], sampleUsers[0]),
              creator = sampleUsers[6],
          ...
          Event(
              ...
              participants = setOf(sampleUsers[1], sampleUsers[8], sampleUsers[10]),
          ...
          Event(
              ...
              participants = setOf(sampleUsers[9], sampleUsers[5]),
              creator = sampleUsers[9],
          ...
          Event(
              ...
              participants = setOf(sampleUsers[12], sampleUsers[0], sampleUsers[15]),
              creator = sampleUsers[12],
          ...
          Event(
              ...
              participants = setOf(sampleUsers[14], sampleUsers[10], sampleUsers[4]),
              creator = sampleUsers[14],
