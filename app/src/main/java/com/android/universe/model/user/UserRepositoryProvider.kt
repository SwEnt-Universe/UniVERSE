 ...
 *
 * This provider supplies a pre-populated [FakeUserRepository] that can be used
 * for UI development and testing purposes. It is intended to be a single shared
 * repository instance across the application.
 */
object UserRepositoryProvider {
    ...
    init {
        ...
        runBlocking {
            sampleUsers.forEach { _repository.addUser(it) }
        }
    }
