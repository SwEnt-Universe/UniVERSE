...
class AddProfileScreenTest {
    ...
    fun displayAllComponents() {
        ...
        composeTestRule.onAllNodesWithTag(AddProfileScreenTestTags.COUNTRY_DROPDOWN_ITEM_PREFIX).assertCountEquals(0)
        ...
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.MONTH_ERROR_NUMBER).assertIsNotDisplayed()
    ...
    fun canEnterUsername() {
        ...
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.USERNAME_FIELD)
        ...
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.USERNAME_ERROR, useUnmergedTree = true)
    ...
    fun canEnterFirstName() {
        ...
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.FIRST_NAME_FIELD)
            .performTextInput(text)
        ...
        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.FIRST_NAME_ERROR, useUnmergedTree = true)
            .assertIsNotDisplayed()
    }
    ...
    fun canEnterLastName() {
        ...
        // Enter text in the field
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.LAST_NAME_FIELD)
            .performTextInput(text)
        ...
        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.LAST_NAME_ERROR, useUnmergedTree = true)
            .assertIsNotDisplayed()
    }
    ...
    fun canEnterDescription() {
        ...
        // Enter text in the field
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.DESCRIPTION_FIELD)
            .performTextInput(text)
    ...
    fun countryFieldExpandsDropdown() {
        ...
        composeTestRule.onAllNodesWithTag(AddProfileScreenTestTags.COUNTRY_DROPDOWN_ITEM_PREFIX)
            .assertCountEquals(0)

        // Click the country field to expand the dropdown
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.COUNTRY_FIELD)
            .performClick()
    ...
    fun canEnterDay() {
        ...
        // Enter text in the field
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.DAY_FIELD)
            .performTextInput(text)
        ...
        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.DAY_ERROR_EMPTY, useUnmergedTree = true)
            .assertIsNotDisplayed()

        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.DAY_ERROR_NUMBER, useUnmergedTree = true)
            .assertIsNotDisplayed()
    }
    ...
    fun canEnterMonth() {
        ...
        // Enter text in the field
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.MONTH_FIELD)
            .performTextInput(text)
        ...
        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.MONTH_ERROR_EMPTY, useUnmergedTree = true)
            .assertIsNotDisplayed()

        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.MONTH_ERROR_NUMBER, useUnmergedTree = true)
            .assertIsNotDisplayed()
    }
    ...
    fun canEnterYear() {
        ...
        // Enter text in the field
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.YEAR_FIELD)
            .performTextInput(text)
        ...
        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.YEAR_ERROR_EMPTY, useUnmergedTree = true)
            .assertIsNotDisplayed()

        // Assert that the error message is not displayed
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.YEAR_ERROR_NUMBER, useUnmergedTree = true)
            .assertIsNotDisplayed()
    }
    ...
    fun saveButtonEnabledOnlyWhenAllRequiredFieldsAreValid() {
        ...
        composeTestRule.onNodeWithTag(AddProfileScreenTestTags.SAVE_BUTTON)
            .assertIsNotEnabled()
